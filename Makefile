...
OBJ1 = Main.o Date.o HashTable.o LinkedList.o Library.o Book.o
OBJ2 = src/Main.o src/Utils/Date/Date.o src/Utils/HashTable/HashTable.o src/Utils/LinkedList/LinkedList.o src/Classes/Library/Library.o src/Classes/Book/Book.o
EXE = src/Main
...
clean:
	rm -f src/Main *.o src/*.o src/Utils/Date/*.o src/Utils/HashTable/*.o src/Utils/LinkedList/*.o src/Classes/Library/*.o src/Classes/Book/*.o
